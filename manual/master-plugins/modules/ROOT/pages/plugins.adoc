...
* xref:photolayer:ROOT:index.adoc[PhotoLayer ] image:managed_plugin.png[]
...
* xref:dead_reckoning:ROOT:index.adoc[Dead Reckoning ] image:managed_plugin.png[]
* xref:otcurrent:ROOT:index.adoc[otidalcurrent ] image:managed_plugin.png[]
...
* xref:sar:ROOT:index.adoc[SAR ] image:managed_plugin.png[]

...
sQiddio is available as a managed plugin:
* Update the master plugins catalog.
* Select the sQiddio entry and install the plugin.
* In the list of installed plugins enable the sQiddio plugin.
...
https://squidd.io/places/17924[place_view]
